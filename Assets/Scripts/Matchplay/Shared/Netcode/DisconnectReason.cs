...
{
    /// <summary>
    /// This class provides some additional context for the connection managed by the MatchplayNetworkClient. If a disconnect occurs, or is expected to occur, client
