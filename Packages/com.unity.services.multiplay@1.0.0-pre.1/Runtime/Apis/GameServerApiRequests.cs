...
namespace Unity.Services.Multiplay.GameServer
{
    ...
    /// <summary>
    /// ServerReadyRequest
    /// Indicates a server is ready to accept players
    /// </summary>
    [Preserve]
    internal class ServerReadyRequest : GameServerApiBaseRequest
    {
    ...
    /// <summary>
    /// ServerSubscribeRequest
    /// Subscribe to game server lifecycle events
    /// </summary>
    [Preserve]
    internal class ServerSubscribeRequest : GameServerApiBaseRequest
    {
        /// <summary>Accessor for serverId </summary>
        [Preserve]
        ...
        /// <summary>
        /// ServerSubscribe Request Object.
        /// Subscribe to game server lifecycle events
        /// </summary>
        /// <param name="serverId">ID of the game server</param>
        ...
        [Preserve]
        public ServerSubscribeRequest(long serverId, string connection, string upgrade)
        {
    ...
    /// <summary>
    /// ServerUnreadyRequest
    /// Indicates a server is unready to receive allocations
    /// </summary>
    [Preserve]
    internal class ServerUnreadyRequest : GameServerApiBaseRequest
    {
        /// <summary>Accessor for serverId </summary>
        [Preserve]
        ...
        /// <summary>
        /// ServerUnready Request Object.
        /// Indicates a server is unready to receive allocations
        /// </summary>
        /// <param name="serverId">ID of the game server</param>
        [Preserve]
        public ServerUnreadyRequest(long serverId)
        {
