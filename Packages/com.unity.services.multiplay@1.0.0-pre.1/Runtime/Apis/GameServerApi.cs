...
namespace Unity.Services.Multiplay.Apis.GameServer
{
    ...
    internal interface IGameServerApiClient
    {
            /// <summary>
            /// Async Operation.
            /// Indicates a server is ready to receive allocations.
            /// </summary>
            /// <param name="request">Request object for ServerReady.</param>
            /// <param name="operationConfiguration">Configuration for ServerReady.</param>
            ...
            Task<Response<JsonObject>> ServerReadyAsync(Unity.Services.Multiplay.GameServer.ServerReadyRequest request, Configuration operationConfiguration = null);

            /// <summary>
            /// Async Operation.
            /// Subscribe to game server lifecycle events.
            /// </summary>
            /// <param name="request">Request object for ServerSubscribe.</param>
            /// <param name="operationConfiguration">Configuration for ServerSubscribe.</param>
            /// <returns>Task for a Response object containing status code, headers.</returns>
            /// <exception cref="Unity.Services.Multiplay.Http.HttpException">An exception containing the HttpClientResponse with headers, response code, and string of error.</exception>
            Task<Response> ServerSubscribeAsync(Unity.Services.Multiplay.GameServer.ServerSubscribeRequest request, Configuration operationConfiguration = null);

            /// <summary>
            /// Async Operation.
            /// Indicates a server is unready to receive allocations.
            /// </summary>
            /// <param name="request">Request object for ServerUnready.</param>
            /// <param name="operationConfiguration">Configuration for ServerUnready.</param>
            /// <returns>Task for a Response object containing status code, headers, and JsonObject object.</returns>
            /// <exception cref="Unity.Services.Multiplay.Http.HttpException">An exception containing the HttpClientResponse with headers, response code, and string of error.</exception>
            Task<Response<JsonObject>> ServerUnreadyAsync(Unity.Services.Multiplay.GameServer.ServerUnreadyRequest request, Configuration operationConfiguration = null);
    ...
    internal class GameServerApiClient : BaseApiClient, IGameServerApiClient
    {
        ...
        /// <returns>Task for a Response object containing status code, headers, and JsonObject object.</returns>
        /// <exception cref="Unity.Services.Multiplay.Http.HttpException">An exception containing the HttpClientResponse with headers, response code, and string of error.</exception>
        public async Task<Response<JsonObject>> ServerReadyAsync(Unity.Services.Multiplay.GameServer.ServerReadyRequest request,
        ...
        /// <returns>Task for a Response object containing status code, headers.</returns>
        /// <exception cref="Unity.Services.Multiplay.Http.HttpException">An exception containing the HttpClientResponse with headers, response code, and string of error.</exception>
        public async Task<Response> ServerSubscribeAsync(Unity.Services.Multiplay.GameServer.ServerSubscribeRequest request,
            Configuration operationConfiguration = null)
        {
        ...
        /// <returns>Task for a Response object containing status code, headers, and JsonObject object.</returns>
        /// <exception cref="Unity.Services.Multiplay.Http.HttpException">An exception containing the HttpClientResponse with headers, response code, and string of error.</exception>
        public async Task<Response<JsonObject>> ServerUnreadyAsync(Unity.Services.Multiplay.GameServer.ServerUnreadyRequest request,
            Configuration operationConfiguration = null)
        {
            var statusCodeToTypeMap = new Dictionary<string, System.Type>() { {"200", typeof(JsonObject)   },{"404", typeof(Models.ErrorResponseBody)   },{"500", typeof(Models.ErrorResponseBody)   } };
