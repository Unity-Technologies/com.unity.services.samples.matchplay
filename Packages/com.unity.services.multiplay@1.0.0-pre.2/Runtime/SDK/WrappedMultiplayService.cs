...
namespace Unity.Services.Multiplay.Internal
{
    internal class WrappedMultiplayService : IMultiplayService
    {
        ...
        public async Task<string> GetPayloadAllocationAsPlainText()
        {
            ...
            throw new InvalidOperationException($"Attempting to get payload allocation when the Allocation UUID[{ServerConfig.AllocatedUuid}] is not valid!");
        }
        ...
        public async Task<IServerCheckManager> StartServerQueryHandlerAsync(ushort maxPlayers, string serverName, string gameType, string buildId, string map)
        {
